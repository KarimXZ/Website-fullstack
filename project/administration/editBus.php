<?php
    ...
    if(authCheck()){
        $id = $_GET['id'];
        $q = mysqli_query($conn, "SELECT * FROM busses WHERE id = $id");
        ...
        echo "  <!DOCTYPE html>
                ...
                <html>
                    ...
                    <body>
                        <center>
                        <form method='post' action='actions/editBus.php'>
                            <input type='hidden' name='id' value='$id' readonly>
                            <p>busName</p><input type='text' name='busName' value='$busName'>
                            <p>line</p><input type='text' name='line' value='$line'>
                            <p>price</p><input type='text' name='price' value='$price'><br>
